...
export default function MemberCard({member, setMemberList}) {
    ...
    return (
        <div className="bg-white shadow-md rounded-xl p-5 border border-gray-200 max-w-md w-full" onClick={handleClick} onMouseEnter={toggleDeleteButton} onMouseLeave={toggleDeleteButton}>
